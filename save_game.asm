...
Global Outputs
	 ...
	 On-disk locations written  : T1/S0 (ID), T5/S0 (engine/vars/free),
	  T6/S0 (ZP snippet), T7/S0 (heap/resources/layout)
...
Returns
	 ...
	 .A =		LOAD_OK after successfully streaming all save blocks.
