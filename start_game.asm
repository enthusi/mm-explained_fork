...
Global Outputs
	...
	sound_mem_attrs[3,4,5,6,8,9]  bit7 set to lock resources
...
clear_game_variables:
        ...
        // Lock sounds 3,4,5,6,8,9 (set bit7 in sound_mem_attrs)
        lda     #SOUND_LOCK_MASK
        sta     sound_mem_attrs + 3
        sta     sound_mem_attrs + 4
        sta     sound_mem_attrs + 5
        sta     sound_mem_attrs + 6
        sta     sound_mem_attrs + 8
        sta     sound_mem_attrs + 9
