...
Global Inputs
	sound_mem_attrs     Per-sound memory attribute table (counter + sign flag)

Global Outputs
	sound_mem_attrs     Updated memory attribute for the selected sound
...
* = $4CDA
dec_sound_refcount:
		lda     sound_mem_attrs,x           // A := current memory attribute for sound X
...
store_final_mem_attr:
		sta     sound_mem_attrs,x           // Commit updated attribute back to table
		rts		
/*
================================================================================
...
Global Inputs
        ...
        sound_mem_attrs               Table of per-sound memory attributes

Global Outputs
        sound_mem_attrs               Entry X decremented via dec_sound_refcount
...
do_decrease:
		jsr     dec_sound_refcount           // Saturating decrement of sound_mem_attrs[X], preserve flags
...
Global Outputs
	sound_mem_attrs               Entry X incremented (unless music active)
...
Description
	...
	- Otherwise increments sound_mem_attrs[X], increasing the resource’s
	reference count.
...
do_increase:
		inc     sound_mem_attrs,x            // Bump memory attribute/refcount for sound X
		rts                                  // Done updating reference count
/*
================================================================================
  allocate_voice
