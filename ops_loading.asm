...
op_load_costume:
		...
		tax                                     	// X := index
		jsr     rsrc_ensure_costume_resident        // load costume resource
...
op_load_script:
		...
		jsr     rsrc_ensure_script_resident    		// load/ensure resident
		jsr     refresh_script_addresses_if_moved   // fix relocated script pointers
		rts                                     
/*
================================================================================
...
op_load_sound:
		...
		jsr     rsrc_ensure_sound_resident          // load sound resource
		jsr     refresh_script_addresses_if_moved   // fix relocated script pointers
		rts                                     
