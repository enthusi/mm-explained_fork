...
* **Script-first approach:**
  Start with the game scripts, locate each corresponding operation in the interpreter (`ops_*.asm`), and then follow the chain down into the engine routines that implement those behaviors.
